...
public class HAMKPSPublicSoap
{
    ...
    public HAMKPSPublicSoap(){}

    public HAMKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HAMKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HAMExtendedSoapSerializationEnvelope envelope= new HAMExtendedSoapSerializationEnvelope(HAMExtendedSoapSerializationEnvelope.VER11);
