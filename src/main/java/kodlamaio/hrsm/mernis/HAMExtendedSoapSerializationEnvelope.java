...
public class HAMExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(HAMDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new HAMStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static HAMDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static HAMDateTimeConverter dateTimeConverter = new HAMStandardDateTimeConverter();

    public HAMExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public HAMExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new HAMMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=HAMHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,HAMExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=HAMHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
